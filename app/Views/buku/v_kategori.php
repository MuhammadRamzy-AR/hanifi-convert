...
<script>
    let add_url = '<?php echo base_url('public/Kategori_buku/add') ?>'
    let read_url = '<?php echo base_url('public/Kategori_buku/read') ?>'
    let edit_url = '<?php echo base_url('public/Kategori_buku/edit') ?>'
    let delete_url = '<?php echo base_url('public/Kategori_buku/delete') ?>'
</script>

<script src="<?php echo base_url() ?>/public/js/Kategori_buku.js"></script>
<?= $this->endSection() ?>